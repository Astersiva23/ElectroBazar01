...
export const getProducts = catchAysncErrors(async (req, res, next) => {
  ...
  export const newProduct = catchAysncErrors(async (req, res) => {
...
export const uploadProductImages = catchAysncErrors(async (req, res) => {
...
export const deleteProductImage = catchAysncErrors(async (req, res) => {
  let product = await Product.findById(req?.params?.id);
  ...
  export const updateProduct = catchAysncErrors(async (req, res) => {
    let product = await Product.findById(req?.params?.id);
...
export const getAdminProducts = catchAysncErrors(async (req, res, next) => {
  ...
  export const deleteProduct = catchAysncErrors(async (req, res) => {
    const product = await Product.findById(req?.params?.id);
