  ...
  async (req, res, next) => {
    ...
    const line_items = body?.orderItems?.map((item) => {
      return {
        ...
        tax_rates: ["txr_1P2gi7SCA4AOwpdj1N3OCh2W"],
    ...
    const shipping_rate =
      body?.itemsPrice >= 200
        ? "shr_1P2ghESCA4AOwpdjd9ntU6H7"
        : "shr_1P2gg2SCA4AOwpdjplZqyogZ";
...
export const stripeWebhook = catchAysncErrors(async (req, res, next) => {
  try {
